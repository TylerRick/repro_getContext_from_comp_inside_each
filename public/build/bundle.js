...
var app = (function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ names, callback });
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			t0 = text$1("UsesContext: ");
    			t1 = text$1(/*context*/ ctx[0]);
    		},
    		m(target, anchor) {
    ...
    class UsesContext extends SvelteComponent$1 {
    	constructor(options) {
    		super();
    		init$1(this, options, instance$1, create_fragment$2, safe_not_equal$1, {});
    	}
    }
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			add_location(div, file, 14, 4, 493);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:2) {#each names as name, i}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:0) <FieldArray let:names>",
    		ctx
    	});
